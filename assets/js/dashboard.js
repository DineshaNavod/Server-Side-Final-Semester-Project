...
window.addEventListener("DOMContentLoaded", () => {
  ...
  const tabParam = urlParams.get("tab") || "performance";
  ...
  const activeTab = document.querySelector(`.tab-item[data-tab="${tabParam}"]`);
  const activePanel = document.getElementById(tabParam);
